...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout->addWidget(checkBox, 13, 0, 1, 3);
        ...
        gridLayout->addWidget(fillButton, 14, 0, 1, 3);
        ...
        gridLayout->addWidget(analyseButton, 15, 0, 1, 3);
        ...
        gridLayout->addWidget(discardButton, 16, 0, 1, 3);
        ...
        gridLayout->addWidget(discardAllButton, 17, 0, 1, 3);

        verticalSpacer = new QSpacerItem(168, 21, QSizePolicy::Minimum, QSizePolicy::Expanding);

        gridLayout->addItem(verticalSpacer, 18, 0, 1, 3);
        ...
        gridLayout->addWidget(aboutButton, 19, 0, 1, 3);
        ...
        gridLayout->addWidget(authorButton, 20, 0, 1, 3);
        ...
        gridLayout->addWidget(outButton, 21, 0, 1, 3);
    ...
    {
        MainWindow->setWindowTitle(QCoreApplication::translate("MainWindow", "\320\233\320\260\320\261\320\276\321\200\320\260\321\202\320\276\321\200\320\275\320\260\321\217 \321\200\320\260\320\261\320\276\321\202\320\260 5", nullptr));
